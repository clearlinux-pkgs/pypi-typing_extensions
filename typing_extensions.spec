...
Source0  : https://files.pythonhosted.org/packages/a5/50/6fbfb5a45d4d8024222849f0731f8d8ddc5c7fe657a8f799bd4c605e93e0/typing_extensions-3.10.0.1.tar.gz
...
%prep
%setup -q -n typing_extensions-3.10.0.1
cd %{_builddir}/typing_extensions-3.10.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630339940
...
cp %{_builddir}/typing_extensions-3.10.0.1/LICENSE %{buildroot}/usr/share/package-licenses/typing_extensions/7ad627868f90ad068bd06801aab97ec1ca34b890
