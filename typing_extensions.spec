...
%prep
%setup -q -n typing_extensions-3.7.4.2
cd %{_builddir}/typing_extensions-3.7.4.2
...
cp %{_builddir}/typing_extensions-3.7.4.2/LICENSE %{buildroot}/usr/share/package-licenses/typing_extensions/7ad627868f90ad068bd06801aab97ec1ca34b890
