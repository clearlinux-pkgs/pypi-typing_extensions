...
Source0  : https://files.pythonhosted.org/packages/1a/23/748b0c9a5578110b31580c8d2643319adcb3ec91f601b50a955051b51f1d/typing_extensions-4.0.0.tar.gz
...
%prep
%setup -q -n typing_extensions-4.0.0
cd %{_builddir}/typing_extensions-4.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637023112
...
cp %{_builddir}/typing_extensions-4.0.0/LICENSE %{buildroot}/usr/share/package-licenses/typing_extensions/7ad627868f90ad068bd06801aab97ec1ca34b890
